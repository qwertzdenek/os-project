...
// TODO: I need somehow use the lambda value in producer task..
// Note: if it's not easy, forget it, I'll rewrite it somehow different ;)
...
DWORD __stdcall task_main_producent(task_common_pointers *in/*, double lambda*/) 
{
    int i = 0;
